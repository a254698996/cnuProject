 ...
 */
package foo2.dao.hibernate.impl;
...
public class CP_Hibernate4DAOImpl implements CP_HibernateDAO {
	 ...
	 */
	private static final Logger logger = LoggerFactory.getLogger(CP_Hibernate4DAOImpl.class);
	
	public CP_Hibernate4DAOImpl() {
		logger.info("create dao .....");
	}
	...
	/*
	 * @see org.cpframework.dao.hibernate.CP_HibernateDAO#findById(java.io.
	 * Serializable )
	 */
	@Override
	...
	/*
	 * @see org.cpframework.dao.hibernate.CP_HibernateDAO#deleteAll(java.util.
	 * Collection )
	 */
	@Override
	...
	/*
	 * @see org.cpframework.dao.hibernate.CP_HibernateDAO#findByCriteria(org.
	...
	/*
	 * @see org.cpframework.dao.hibernate.CP_HibernateDAO#
	 * findByNamedQueryAndNamedParam (java.lang.String, java.lang.String[],
	 * java.lang.Object[])
	 */
	@Override
