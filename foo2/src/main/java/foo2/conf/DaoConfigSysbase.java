...
//@Import({ DataSourceConfigSysbase.class })
//public class DaoConfigSysbase {
//
//	private static final Logger logger = Logger.getLogger(DaoConfigSysbase.class);
//
...
//	}
//
//	@Resource(name = "sysbaseDataSource")
//	public DataSource dataSource;
//
//	@Bean(name = "sysbaseSessionFactory")
//	public LocalSessionFactoryBean localSessionFactoryBean() {
//		logger.info("sysbaseSessionFactory");
