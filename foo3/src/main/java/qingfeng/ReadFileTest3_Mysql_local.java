...
//// write to mysql db 
//// same time read multifile 
//public class ReadFileTest3_Mysql_local {
...
//		String impFile = new ReadFileTest3_Mysql_local().getImpFile(appRootPath);
//
//		// System.out.println("010071".substring(0, 5));
//		// System.out.println("010071".substring(0, 6));
//	}
//
//	public String getImpFile(String appRootPath) {
//		try {
...
//			}
//			// TODO 改为
//			int fileNum = impFileSet.size();
//			CyclicBarrier cyc = new CyclicBarrier(fileNum);
//			
//			// boolean result = imp(errorLogPath, impAppTempFile, dbName,
//			// impPropCardBin, isTest);
//			boolean result = true;
//
...
//	}
//
//	private Map<String, ImpProp> getImpProMap(){
...
//	}
//	
//	public void imp(ImpProp impProp) throws Exception {
//
