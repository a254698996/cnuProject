...
public class LeaderLatchTest {
	...
	private static void haha() {
		LeaderSelectorListener listener = new HahaLeaderSelectorListenerAdapter();
	...
	public static class HahaLeaderSelectorListenerAdapter extends LeaderSelectorListenerAdapter {
	...
	private static CuratorFramework getClient() {
		...
		CuratorFramework client = CuratorFrameworkFactory.builder().connectString("127.0.0.1:9181")
