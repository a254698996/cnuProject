...
<%@include file="../header.jsp" %>
 ...
 <link href="http://www.maliuer.com/Content/Style/Commodity.css" rel="stylesheet" type="text/css" />
    ...
    <div class="box">
        <div class="boxone">
            <div class="onebox"> 
            <form action="${ctx }/user/indexList/${categoryId}" method="get"></form>
                <div class="oneboxtwo">
...
<!-- 			                      <span>   5</span>&nbsp;元 -->
            ...
            <div class="boxthreead"> </div>
                    ...
                    <!-- maxResults=steps -->
		  <tag:paginate steps="${steps}" pageIndex= "${pageIndex }" count="${count}" uri="${ctx}/user/indexList/${categoryId}?pageIndex={0}" parms="${parms}" />
        </div>
    </div>
    </form>
		<div class="footer">
