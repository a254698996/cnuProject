            ...
            <div class="shop_inner"> 
               ...
               <div class="shop_jianjie">
                    ...
                    <c:forEach items="${goodsList }" var="userGoods">
                        <li>
                            <a href="${ctx}/user/exchange/${goods.id}?exchangeGoodsId=${userGoods.id }">  用此物品交换  </a>
                            ...
                            <span class="jianjie_tit">用户名称：</span><span class="jianjie_con">${userGoods.goodsCategorySubName }</span>
                        </li>
                     </c:forEach>
                    </ul>
                </div>
