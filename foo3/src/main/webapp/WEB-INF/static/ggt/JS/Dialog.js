...
function Dialog(contentObj, title, callBack, showBtn) {
    ...
    $(document.body).append("<div id='____ModelDiv' style='position: fixed;top:0px;left:0px;z-index:9998;filter:alpha(opacity=40);opacity:0.4;'>&nbsp;</div>");
    ...
    modelDiv.css({ width: f[1] + "px", height: f[0] + "px", display: "block", "background-color": "#4D4D4D" });
